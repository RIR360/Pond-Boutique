...
export default function ProductDetail({ product }: { product: ProductType }) {
  ...
  const [size, setSize] = useState<string | undefined>(sizes[2])
    ...
    <section className="max-w-7xl mx-auto">
      <div className="grid md:grid-cols-2 gap-8 items-start py-16">
        ...
        <div>
          ...
          <p className="text-neutral-700 mt-4 mb-6">{product.description || "A beautiful, sustainably made piece."}</p>
          ...
          {added && <div className="text-sm text-emerald-600 mb-4">Added to cart</div>}

          <div className="border-t pt-6 mt-6 text-sm text-neutral-600">
            <p className="mb-2">Shipping: Free standard shipping on orders over $50. Expedited options available at checkout.</p>
            <p>Returns: 30-day returns. Item must be in original condition. See our returns policy for details.</p>
          </div>
        </div>
      </div>
        ...
        <div className="lg:col-span-2">
          ...
          <div className="space-y-4">
            <div className="p-4 border rounded">
              ...
              <div className="text-sm text-neutral-600">Comfortable, elegant, and fits true to size. Love the fabric!</div>
            </div>
          </div>
        </div>
        ...
        <aside className="p-4 border rounded">
          ...
          <div className="space-y-3">
            <div className="flex items-center gap-3">
              <img src="/images/pexels-photo-31874438.jpeg" alt="alt" className="w-12 h-12 object-cover rounded" />
              <div>
            ...
            <div className="flex items-center gap-3">
              <img src="/images/pexels-photo-22431192.jpeg" alt="alt" className="w-12 h-12 object-cover rounded" />
              <div>
